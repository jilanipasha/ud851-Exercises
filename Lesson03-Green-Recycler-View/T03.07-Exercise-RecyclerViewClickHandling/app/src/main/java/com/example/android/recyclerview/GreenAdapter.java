 ...
 * contents are green.
 */
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> implements View.OnClickListener {
    ...
    interface ListItemClickListener{ void onListItemClick(); }
    ...
    // OMPLETED (4) Add a ListItemClickListener as a parameter to the constructor and store it in mOnClickListener
    /**
