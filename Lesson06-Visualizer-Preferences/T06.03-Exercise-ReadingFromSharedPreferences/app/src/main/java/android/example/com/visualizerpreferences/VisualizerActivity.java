...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // COMPLETETD (1) Change the name of default setup to setupSharedPreferences
    private void setupSharedPreferences() {
        // COMPLETETD (2) Get a reference to the default shared preferences from the PreferenceManager class
